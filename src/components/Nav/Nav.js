...
const Nav = () => {
  ...
  const handleLogout = () => {
    fetch("https://uppercase-back-1eec3e8a2cf1.herokuapp.com/logout", {
      method: "POST",
      credentials: "include",
    })
      .then(() => {
    ...
    <div>
      <nav className="d-flex flex-column justify-content-center text-center navbar navbar-expand-sm navbar-light ">
        ...
        <div className="d-flex">
          <Link className="" to="/">
            <img src={`https://uppercase-back-1eec3e8a2cf1.herokuapp.com/img/logo1.png`} className="w-75" style={{ marginLeft: "-50px"}}/>
          </Link>
