...
function About() {
  return (
    <div className="container text-center">
      ...
      <h2 className="">Notre Histoire</h2>
      <p className="">
      ...
      <h2 className="">Pourquoi le click-and-collect ?</h2>
      <p className="">
      ...
      <h2 className="">Pourquoi <Link className="text-success text-decoration-none" to="/">Uppercase.com</Link> ?</h2>
      <p className="">
