...
function About() {
  return (
    <div className="container text-center">
      <img src="https://uppercase-app-back-efd9a0ca1970.herokuapp.com/img/qui.png" className="mt-4  " alt="buy" />
      <h1 className="c2 pacifico">Qui sommes-nous ?</h1>
      <p className="roboto">
      ...
      <h2 className="c2 pacifico">Notre Histoire</h2>
      <p className="roboto">
      ...
      <h2 className="c2 pacifico">Pourquoi le click-and-collect ?</h2>
      <p className="roboto">
      ...
      <h2 className="c2 pacifico">Pourquoi <Link className="text-success   text-decoration-none" to="/">Uppercase.com</Link> ?</h2>
      <p className="roboto">
        Pour mettre en place ce service, nous avons choisi de collaborer avec
        <Link className="fw-bold text-success tdn" to="/"> Uppercase.com</Link>, 
      ...
      <p className="roboto">
        Nous vous invitons à découvrir <Link className="fs-5 text-orange tdn" to="/products">nos produits</Link> et à profiter de la facilité de commande en ligne. 
