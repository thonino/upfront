  ...
  return (
    <div className="container">
      <div className="text-center">
        <h1 className="c1 pacifico">Mentions Légales</h1>
          <p className="c3 roboto"><strong>En vigueur au 01/10/2023</strong></p>
        <span>
          <p>
      ...
      <span>
        ...
        <p>
          L’édition et la direction de la publication du Site est assurée par WAFORMATION, domiciliée au
          1 rue de la joie Paris 75001, dont l'adresse e-mail est contact@maboulangerie.fr.
        </p>

        <h2>ARTICLE 2 - L'HEBERGEUR</h2>
        <p>
          L'hébergeur du Site est la société ionos, dont le siège social est situé au 
          7 PL DE LA GARE 57200 SARREGUEMINES, avec le numéro de téléphone : 08 90 10 93 62.
        </p>
        ...
        <p>
          ...
          notre <Link className="text-success" to="/dataprotection">Politique de Confidentialité</Link>.
        </p>
        <p>
