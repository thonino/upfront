...
function MessageSent() {
  ...
  useEffect(() => {
    axios
      .get("https://uppercase-back-1eec3e8a2cf1.herokuapp.com/messagesent.js", { withCredentials: true })
      .then((response) => {
  ...
  const handleDelete = (id) => {
    fetch(`https://uppercase-back-1eec3e8a2cf1.herokuapp.com/deletemessage/${id}`, { withCredentials: true }, {
      method: "DELETE",
    })
      .then(() => {
